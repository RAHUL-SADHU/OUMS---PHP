...
--
-- Host: localhost
-- Generation Time: Jun 26, 2021 at 09:21 AM
...
(7, 'Bhavesh', 'Sadhu', 'bhavesh@b.com', '123456', 'Admin');
...
(18, 26, 1, 4, '2021-04-18', 3, 12, '2021-04-22', 2, 'borrow'),
(19, 26, 1, 4, '2021-04-18', 2, 12, '2021-04-30', 12, 'borrow');
...
(29, 'M.COM', '1222', 'Master of commerce', 2001, '2021-04-20 04:42:07');
...
(2, 26, 1, 'Midterm Exam', 1, 4, 30, 20, 0),
(3, 26, 1, 'Midterm Exam', 1, 6, 0, 0, 0),
(4, 26, 1, 'Final Exam', 1, 1, 50, 27, 30),
(5, 26, 1, 'Final Exam', 1, 4, 50, 55, 35),
...
(1, 'Government Engineering Collage Gandhinagar', 1998, 'https://nandkunvarbamahilacollege.com/', 'nmcbhavnagar@gmail.com', 2147483647, 'Devraj nagar - 2, Saher farti sadak, Near Shivaji Circle, Ghogha Road, Bhavnagar.\r\n\r\n\"\"\"');
...
(1, 28, 1, 'first_namesdfs', 'Sadhu', 'As', 584, 'A+', 'male', 'Hindu', 'Indian', '2021-03-11', '08487054954', 'Test', '08487054954', 'testt', '08487054954', 'Openxcell', 'TA VEJALPUR DIST AHMEDABAD ', 'AndroidR-Google.png'),
(4, 27, 1, 'first_namesdf', 'Sadhu', 's', 4545, 'A+', 'male', 'Hindu', 'Indian', '2020-12-18', '08487054954', '44fsdfs', '84754', 'sdfsdf', '46455565sdfsdf', 'Openxcell', 'TA VEJALPUR DIST AHMEDABAD', 'images (1).jpeg'),
...
--
ALTER TABLE `fees`
  MODIFY `fees_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `subject`
  MODIFY `subject_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `d` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`),
