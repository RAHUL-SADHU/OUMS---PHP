...
<div class="container-fluid">
				...
				>
					<thead>
						<tr>
							...
							<th data-field ="book_id" data-visible="false">Book Id</th>
							<th data-field="quantity">Quantity</th>
							<th data-field="issue">Issue</th>
							<th data-field="return">Return</th>
							<th data-field="fine">Fine</th>
							<th data-field="operate" data-formatter="operateFormatter" data-events="operateEvents" data-print-ignore=true >Delete</th>
						</tr>
					</thead>
				</table>
			</div>
	...
	type: "POST",
	url: "table_data.php",
	data: {action: 'add_borrow_book',department_id : department_id ,
	                                 semester : semester,
